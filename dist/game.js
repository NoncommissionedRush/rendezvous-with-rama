...
})({"4LOpm":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "c4c2d47cf7d12838";
"use strict";
...
},{"kaboom":"hKg7i","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"hKg7i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Es
);
var jt = Object.defineProperty, cn = Object.defineProperties;
var ln = Object.getOwnPropertyDescriptors;
var Qt = Object.getOwnPropertySymbols;
var dn = Object.prototype.hasOwnProperty, hn = Object.prototype.propertyIsEnumerable;
var Bt = (e, t, r)=>t in e ? jt(e, t, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: r
...
, ne = (e, t)=>{
    ...
    if (Qt) for (var r of Qt(t))hn.call(t, r) && Bt(e, r, t[r]);
    return e;
}, se = (e, t)=>cn(e, ln(t))
;
var i = (e, t)=>jt(e, "name", {
...
;
var Kt = (e, t, r)=>(Bt(e, typeof t != "symbol" ? t + "" : t, r), r)
;
var er = (e, t, r)=>new Promise((a, b)=>{
        var P = (V)=>{
            try {
                D(r.next(V));
            } catch (A) {
        ...
        }, D = (V)=>V.done ? a(V.value) : Promise.resolve(V.value).then(P, v)
        ;
...
i(I, "rgb");
function ir(e, t, r) {
    if (t == 0) return I(255 * r, 255 * r, 255 * r);
    let a = i((A, L, N)=>(N < 0 && (N += 1), N > 1 && (N -= 1), N < 1 / 6 ? A + (L - A) * 6 * N : N < 0.5 ? L : N < 2 / 3 ? A + (L - A) * (2 / 3 - N) * 6 : A)
    , "hue2rgb"), b = r < 0.5 ? r * (1 + t) : r + t - r * t, P = 2 * r - b, v = a(P, b, e + 1 / 3), D = a(P, b, e), V = a(P, b, e - 1 / 3);
...
function le(e) {
    return {
        ...
        mult (t) {
            let r = [];
            for(let a = 0; a < 4; a++)for(let b = 0; b < 4; b++)r[a * 4 + b] = this.m[0 + b] * t.m[a * 4 + 0] + this.m[4 + b] * t.m[a * 4 + 1] + this.m[8 + b] * t.m[a * 4 + 2] + this.m[12 + b] * t.m[a * 4 + 3];
            return le(r);
        },
        multVec4 (t) {
            return {
        ...
        invert () {
            ...
            for(let _ = 0; _ < 4; _++)for(let z = 0; z < 4; z++)t[_ * 4 + z] *= 1 / T;
            return le(t);
        }
    };
}
...
i(Pt, "wave");
var fn = 1103515245, mn = 12345, or = 2147483648, St = Dt(Date.now());
function Dt(e) {
    return {
        seed: e,
        gen (...t) {
            if (t.length === 0) return this.seed = (fn * this.seed + mn) % or, this.seed / or;
            if (t.length === 1) {
                if (typeof t[0] == "number") return this.gen(0, t[0]);
                if (We(t[0])) return this.gen(c(0, 0), t[0]);
                if (qe(t[0])) return this.gen(I(0, 0, 0), t[0]);
            } else if (t.length === 2) {
                if (typeof t[0] == "number" && typeof t[1] == "number") return this.gen() * (t[1] - t[0]) + t[0];
                if (We(t[0]) && We(t[1])) return c(this.gen(t[0].x, t[1].x), this.gen(t[0].y, t[1].y));
                if (qe(t[0]) && qe(t[1])) return I(this.gen(t[0].r, t[1].r), this.gen(t[0].g, t[1].g), this.gen(t[0].b, t[1].b));
            }
        }
    };
}
...
i(At, "testRectRect");
function Mt(e, t) {
    if (e.p1.x === e.p2.x && e.p1.y === e.p2.y || t.p1.x === t.p2.x && t.p1.y === t.p2.y) return null;
...
i(Se, "testLineLine");
function at(e, t) {
    return Be(e, t.p1) || Be(e, t.p2) ? !0 : !!Se(t, mt(e.p1, c(e.p2.x, e.p1.y))) || !!Se(t, mt(c(e.p2.x, e.p1.y), e.p2)) || !!Se(t, mt(e.p2, c(e.p1.x, e.p2.y))) || !!Se(t, mt(c(e.p1.x, e.p2.y), e.p1));
}
i(at, "testRectLine");
function Be(e, t) {
...
function ft(e, t) {
    return {
        p1: c(e.p1.x - t.p2.x, e.p1.y - t.p2.y),
        p2: c(e.p2.x - t.p1.x, e.p2.y - t.p1.y)
    };
}
i(ft, "minkDiff");
function mt(e, t) {
...
i(pr, "downloadBlob");
var pt = "topleft", Ke = 9, yt = 65536, yr = 64, yn = `
...
function br(e, t) {
    let r = (()=>{
        var C;
        let o = P(Xt, Wt), f = b(new ImageData(new Uint8ClampedArray([
            255,
            255,
            255,
            255
        ]), 1, 1)), U = (C = t.background) != null ? C : I(0, 0, 0);
        ...
        let E = b(new ImageData(new Uint8ClampedArray([
            128,
            128,
            128,
            255,
    ...
    function P(o = Xt, f = Wt) {
        ...
        if (e.shaderSource(E, R), e.shaderSource(C, x), e.compileShader(E), e.compileShader(C), U = e.getShaderInfoLog(E)) throw new Error(U);
        if (U = e.getShaderInfoLog(C)) throw new Error(U);
...
`) throw new Error(U);
    ...
    i(P, "makeShader");
    function v(o, f, U, R) {
        let x = o.width / f, E = o.height / U, C = 1 / x, O = 1 / E, H = {
        }, re = R.split("").entries();
        for (let [Z, ee] of re)H[ee] = c(Z % x * C, Math.floor(Z / x) * O);
        return {
            tex: o,
            map: H,
            qw: C,
    ...
    i(V, "flush");
    function A() {
        e.clear(e.COLOR_BUFFER_BIT), t.background || T({
            width: Ee(),
            height: ce(),
            quad: de(0, 0, Ee() * xe() / yr, ce() * xe() / yr),
            tex: r.bgTex
        }), r.drawCalls = 0, r.transformStack = [], r.transform = le();
    }
    i(A, "frameStart");
    function L() {
    ...
    function T(o) {
        ...
        ye(), j(o.pos), y(o.angle), oe(o.scale), j(x), D([
            {
                pos: Pe(-f / 2, U / 2, 0),
    ...
    function _(o) {
        ...
        if (o.tiled) {
            ...
            for(let Z = 0; Z < C; Z++)for(let ee = 0; ee < O; ee++)T(se(ne({
            }, o), {
                pos: (o.pos || c(0)).add(c(U * Z, R * ee)).sub(re),
        ...
        } else o.width && o.height ? (x.x = o.width / U, x.y = o.height / R) : o.width ? (x.x = o.width / U, x.y = x.x) : o.height && (x.y = o.height / R, x.x = x.y), T(se(ne({
        }, o), {
            scale: x.scale(o.scale || c(1)),
            tex: o.tex,
            quad: f,
    ...
    function z(o, f, U, R, x, E = 1) {
        ...
        for(let re = R; re < x; re += O)H.push(o.add(f * Math.cos(re), U * Math.sin(re)));
    ...
    function X(o) {
        ...
        if (o.width <= 0 || o.height <= 0) return;
        let f = o.width, U = o.height, x = Ge(o.origin || pt).add(1, 1).scale(c(f, U).scale(-0.5)), E = [
            c(0, 0),
            c(f, 0),
            c(f, U),
            c(0, U)
        ...
        if (o.radius) {
            ...
            E = [
                c(C, 0),
                c(f - C, 0),
                ...z(c(f - C, C), C, C, 270, 360),
                c(f, C),
                c(f, U - C),
                ...z(c(f - C, U - C), C, C, 0, 90),
                c(f - C, U),
                c(C, U),
                ...z(c(C, U - C), C, C, 90, 180),
                c(0, U - C),
                c(0, C),
                ...z(c(C, C), C, C, 180, 270)
            ];
    ...
    function W(o) {
        let { p1: f , p2: U  } = o;
        if (!f || !U) throw new Error('drawLine() requires properties "p1" and "p2".');
        let R = o.width || 1, x = U.sub(f).unit().normal().scale(R * 0.5), E = [
            f.sub(x),
            f.add(x),
            U.add(x),
            U.sub(x)
    ...
    function k(o) {
        ...
        if (!(f.length < 2)) {
            if (o.radius && f.length >= 3) {
                let U = f[0].dist(f[1]);
                for(let x = 1; x < f.length - 1; x++)U = Math.min(f[x].dist(f[x + 1]), U);
            ...
            } else for(let U = 0; U < f.length - 1; U++)W(se(ne({
            }, o), {
                p1: f[U],
                p2: f[U + 1]
            }));
    ...
    function F(o) {
        ...
        o.radiusX === 0 || o.radiusY === 0 || ae(se(ne({
        }, o), {
            pts: z(c(0), o.radiusX, o.radiusY, (f = o.start) != null ? f : 0, (U = o.end) != null ? U : 360, o.resolution),
            radius: 0
        }));
    }
    i(F, "drawEllipse");
    function ae(o) {
        ...
        let f = o.pts.length;
        if (!(f < 3)) {
            if (ye(), j(o.pos), oe(o.scale), y(o.angle), j(o.offset), o.fill !== !1) {
...
` && (fe.push(ge), re += O, ge === " " && (be = fe.length)), ee = Math.max(ee, re), me++;
            ...
            ge.forEach((Ze, Te)=>{
                ...
                if (ze += 1, Je) {
                    let we = {
                        ...
                        ch: Ze,
                        pos: c(Me.x + wt + et + gt, Me.y + xt + Ut),
                        opacity: o.opacity,
    ...
    function Re() {
        if (t.width && t.height && t.stretch) {
            ...
            } else r.width = t.width, r.height = t.height, e.viewport(0, 0, e.drawingBufferWidth, e.drawingBufferHeight);
        } else r.width = e.drawingBufferWidth / xe(), r.height = e.drawingBufferHeight / xe(), e.viewport(0, 0, e.drawingBufferWidth, e.drawingBufferHeight);
    }
    i(Re, "updateSize");
    function Ee() {
        return r.width;
...
function gr(e = {
    ...
    let v = r.canvas.getContext("webgl", {
        antialias: !0,
        depth: !0,
        stencil: !0,
        alpha: !0,
    ...
    r.isTouch = "ontouchstart" in window || navigator.maxTouchPoints > 0, r.canvas.addEventListener("mousemove", (w)=>{
        W() ? r.mousePos = c(w.offsetX, w.offsetY).scale(1 / r.scale) : r.mousePos = c(w.offsetX, w.offsetY).scale(1 / r.scale), r.mouseDeltaPos = c(w.movementX, w.movementY).scale(1 / r.scale), r.isMouseMoved = !0;
    });
    let D = [
        "left",
        "middle",
    ...
    r.canvas.addEventListener("mousedown", (w)=>{
        ...
        b.includes(G) && w.preventDefault(), G.length === 1 && r.charInputted.push(w.key), G === "space" && r.charInputted.push(" "), w.repeat ? (r.isKeyPressedRepeat = !0, r.keyStates[G] = "rpressed") : (r.isKeyPressed = !0, r.keyStates[G] = "pressed");
        ...
        w.preventDefault();
        let G = w.touches[0];
        r.mousePos = c(G.clientX, G.clientY).scale(1 / r.scale), r.isMouseMoved = !0;
        ...
        switch(document.visibilityState){
            case "visible":
                r.skipTime = !0, (w = e.audioCtx) == null || w.resume();
                break;
            case "hidden":
    ...
    function k(w) {
        let G = i((De)=>{
            ...
            let Re = De / 1000, Ee = Re - r.realTime;
            r.realTime = Re, r.skipTime || (r.dt = Ee, r.time += r.dt, r.fpsBuf.push(1 / r.dt), r.fpsTimer += r.dt, r.fpsTimer >= 1 && (r.fpsTimer = 0, r.fps = Math.round(r.fpsBuf.reduce((ce, xe)=>ce + xe
            ) / r.fpsBuf.length), r.fpsBuf = [])), r.skipTime = !1, w();
            for(let ce in r.keyStates)r.keyStates[ce] = Ur(r.keyStates[ce]);
            for(let ce1 in r.mouseStates)r.mouseStates[ce1] = Ur(r.mouseStates[ce1]);
            r.charInputted = [], r.isMouseMoved = !1, r.isKeyPressed = !1, r.isKeyPressedRepeat = !1, r.loopID = requestAnimationFrame(G);
        }, "frame");
        r.stopped = !1, r.loopID = requestAnimationFrame(G);
    }
    i(k, "run");
    function q() {
        cancelAnimationFrame(r.loopID), r.stopped = !0;
    }
    return i(q, "quit"), {
        gl: v,
        mousePos: V,
        ...
        run: k,
        quit: q,
        isFocused: ()=>document.activeElement === r.canvas
        ,
        focus: ()=>r.canvas.focus()
        ,
        canvas: r.canvas,
        isTouch: r.isTouch,
        scale: r.scale,
...
var xr = 0, Er = 3, En = 0, vn = 3, Cn = -1200, Bn = 1200;
function vr() {
...
var qt = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", Dr = " \u263A\u263B\u2665\u2666\u2663\u2660\u2022\u25D8\u25CB\u25D9\u2642\u2640\u266A\u266B\u263C\u25BA\u25C4\u2195\u203C\xB6\xA7\u25AC\u21A8\u2191\u2193\u2192\u2190\u221F\u2194\u25B2\u25BC !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u2302\xC7\xFC\xE9\xE2\xE4\xE0\xE5\xE7\xEA\xEB\xE8\xEF\xEE\xEC\xC4\xC5\xC9\xE6\xC6\xF4\xF6\xF2\xFB\xF9\xFF\xD6\xDC\xA2\xA3\xA5\u20A7\u0192\xE1\xED\xF3\xFA\xF1\xD1\xAA\xBA\xBF\u2310\xAC\xBD\xBC\xA1\xAB\xBB\u2591\u2592\u2593\u2502\u2524\u2561\u2562\u2556\u2555\u2563\u2551\u2557\u255D\u255C\u255B\u2510\u2514\u2534\u252C\u251C\u2500\u253C\u255E\u255F\u255A\u2554\u2569\u2566\u2560\u2550\u256C\u2567\u2568\u2564\u2565\u2559\u2558\u2552\u2553\u256B\u256A\u2518\u250C\u2588\u2584\u258C\u2590\u2580\u03B1\xDF\u0393\u03C0\u03A3\u03C3\xB5\u03C4\u03A6\u0398\u03A9\u03B4\u221E\u03C6\u03B5\u2229\u2261\xB1\u2265\u2264\u2320\u2321\xF7\u2248\xB0\u2219\xB7\u221A\u207F\xB2\u25A0";
function $t(e) {
    let t = new Image;
...
function Ar(e, t, r = {
    ...
    function b(S) {
        ...
        return a.loaders[T] = !1, a.lastLoaderID++, S.catch((_ = r.errHandler) != null ? _ : console.error).finally(()=>a.loaders[T] = !0
        );
    }
    i(b, "load");
    function P() {
        let S = 0, T = 0;
        for(let _ in a.loaders)S += 1, a.loaders[_] && (T += 1);
        return T / S;
    }
    i(P, "loadProgress");
    function v(S) {
    ...
    function Y(S = 1, T = 1, _ = 0, z = 0, X = 1, W = 1) {
        let k = [], q = X / S, $ = W / T;
        for(let F = 0; F < T; F++)for(let ae = 0; ae < S; ae++)k.push(de(_ + ae * q, z + F * $, q, $));
        return k;
    }
    i(Y, "slice");
    function ie(S, T) {
        return b(typeof T == "string" ? fetch(v() + T).then((_)=>_.json()
        ).then((_)=>ie(S, _)
        ) : j(null, S).then((_)=>{
            let z = {
            }, X = _.tex.width, W = _.tex.height;
            for(let k in T){
                let q = T[k], $ = {
                    tex: _.tex,
    ...
    function j(S, T, _ = {
        ...
        function z(X, W, k = {
            ...
            let q = e.makeTex(W, k), $ = Y(k.sliceX || 1, k.sliceY || 1), F = {
                tex: q,
                frames: $,
                anims: k.anims || {
                }
        ...
        return i(z, "loadRawSprite"), b(new Promise((X, W)=>{
            if (!T) return W(`expected sprite src for "${S}"`);
            if (typeof T == "string") {
                let k = Rr(T) ? T : a.loadRoot + T;
                $t(k).then((q)=>X(z(S, q, _))
                ).catch(W);
            } else X(z(S, T, _));
        }));
    }
    ...
    function oe(S, T) {
        return b(new Promise((_, z)=>{
            fetch(v() + T).then((X)=>X.json()
            ).then((X)=>er(this, null, function*() {
    ...
    function ue(S, T, _, z = !1) {
        ...
        return i(X, "loadRawShader"), b(new Promise((W, k)=>{
            ...
            if (i(q, "resolveUrl"), z) Promise.all([
                q(T),
                q(_)
            ]).then(([$, F])=>{
                W(X(S, $, F));
    ...
    function y(S, T) {
        let _ = a.loadRoot + T;
        return b(new Promise((z, X)=>{
            if (!T) return X(`expected sound src for "${S}"`);
...
var Ir = i((e)=>{
    ...
    i(t, "explode");
    let r = null, a = null;
    e.loadSprite(null, Vr).then((P)=>r = P
    ), e.loadSprite(null, kr).then((P)=>a = P
    );
    function b(P, v = {
    }) {
        var N, Y;
        let D = (v.speed || 1) * 5, V = v.scale || 1, A = e.add([
            e.pos(P),
            e.sprite(a),
            e.scale(0),
            e.stay(),
...
var Es = i((e = {
    ...
    function j(n) {
        ...
        if (!u) throw new Error(`frame not found: ${(m = n.frame) != null ? m : 0}`);
        a.drawTexture(se(ne({
        }, n), {
            tex: s.tex,
    ...
    function $(n) {
        let s = new Map, u = {
            ...
            use (l) {
                ...
                for(let p in l)if (!k.has(p)) {
                    ...
                    this[p] === void 0 && Object.defineProperty(this, p, {
                        get: ()=>h[p]
                        ,
                        set: (M)=>h[p] = M
                        ,
                ...
                let g = i(()=>{
                    if (!!l.require) {
                        for (let p of l.require)if (!this.c(p)) throw new Error(`comp '${l.id}' requires comp '${p}'`);
                    }
                }, "checkDeps");
                this.exists() ? (l.add && l.add.call(this), l.load && _e(()=>l.load.call(this)
                ), g()) : l.require && h.cleanups.push(this.on("add", ()=>{
                    g();
                }));
            },
            unuse (l) {
            ...
            is (l) {
                if (l === "*") return !0;
                if (Array.isArray(l)) {
                    for (let h of l)if (!this.c(h)) return !1;
                    return !0;
            ...
            inspect () {
                ...
                for (let [h, g] of s)l[h] = g.inspect ? g.inspect() : null;
                return l;
            },
            onUpdate (l) {
        ...
        for (let l1 of n)m.use(l1);
        return m;
    }
    i($, "make");
    function F(n) {
        let s = $(n);
        return s._id = y.objs.push(s), s.trigger("add"), _e(()=>s.trigger("load")
        ), s;
    }
    i(F, "add");
    function ae(n) {
    ...
    i(w, "on");
    function G(n, s) {
        if (typeof n == "function" && s === void 0) return F([
            {
                update: n
            }
        ]).destroy;
        if (typeof n == "string") return w("update", n, s);
    }
    i(G, "onUpdate");
    function De(n, s) {
        if (typeof n == "function" && s === void 0) return F([
        ...
        if (typeof n == "string") return w("draw", n, s);
    }
    i(De, "onDraw");
    function Re(n, s, u) {
        let d = w("collide", n, (h, g, p)=>g.is(s) && u(h, g, p)
        ), m = w("collide", s, (h, g, p)=>g.is(n) && u(g, h, p)
        ), l = G(n, (h)=>{
            if (!h.area) throw new Error("onCollide() requires the object to have area() component");
    ...
    function ce(n, s, u) {
        return G(n, (d)=>{
            if (!d.area) throw new Error("onHover() requires the object to have area() component");
    ...
    function f(n, s) {
        if (Array.isArray(n)) {
            ...
            ;
        } else return typeof n == "function" ? y.on("input", ()=>r.isKeyPressed() && n()
        ) : y.on("input", ()=>r.isKeyPressed(n) && s()
        );
    }
    i(f, "onKeyPress");
    function U(n, s) {
        ...
        ) : y.on("input", ()=>r.isKeyPressedRepeat(n) && s()
        );
    }
    ...
    function R(n, s) {
        ...
        ) : y.on("input", ()=>r.isKeyReleased(n) && s()
        );
    }
    i(R, "onKeyRelease");
    function x(n, s) {
        return typeof n == "function" ? y.on("input", ()=>r.isMouseDown() && n(Y())
        ) : y.on("input", ()=>r.isMouseDown(n) && s(Y())
        );
    }
    i(x, "onMouseDown");
    function E(n, s) {
        return typeof n == "function" ? y.on("input", ()=>r.isMousePressed() && n(Y())
        ) : y.on("input", ()=>r.isMousePressed(n) && s(Y())
        );
    }
    i(E, "onMousePress");
    function C(n, s) {
        return typeof n == "function" ? y.on("input", ()=>r.isMouseReleased() && n(Y())
        ) : y.on("input", ()=>r.isMouseReleased(n) && s(Y())
        );
    }
    i(C, "onMouseRelease");
    function O(n) {
        ...
        return {
            ...
            moveBy (...s) {
                ...
                if (this.solid && ((h = this.area) == null ? void 0 : h.shape) === "rect") {
                    ...
                    me((p)=>{
                        var Nt;
                        if (!this.exists() || p === this || !p.solid || ((Nt = p.area) == null ? void 0 : Nt.shape) !== "rect") return;
                        ...
                        let K = {
                            p1: c(0),
                            p2: c(d, m)
                        }, te = 1, ke = B.p1, Ie = c(B.p1.x, B.p2.y), Le = B.p2, st = c(B.p2.x, B.p1.y), it = 0, Ht = {
                            right: {
                                p1: ke,
                                p2: Ie
                            },
    ...
    function Lr(n = {
        ...
        return {
            ...
            onCollide (m, l) {
                let h = this.onUpdate(()=>this._checkCollisions(m, l)
                ), g = this.on("collide", (p, M)=>p.is(m) && l(p, M)
                );
                return ()=>[
                        h,
                        g
            ...
            pushOut (m) {
                var B;
                if (m === this || ((B = m.area) == null ? void 0 : B.shape) !== "rect") return null;
                let l = this.worldArea(), h = m.worldArea(), g = ft(l, h);
                if (!Be(g, c(0))) return null;
            ...
            worldArea () {
                ...
                if (m == null || l == null) throw new Error("failed to get area dimension");
            ...
            screenArea () {
                ...
                return this.fixed ? m : {
                    shape: "rect",
                    p1: y.camMatrix.multVec2(m.p1),
                    p2: y.camMatrix.multVec2(m.p2)
                };
            }
        };
    }
    ...
    function Fr(n, s = {
        ...
        return i(m, "calcTexScale"), {
            ...
            update () {
                ...
                if (h.speed === 0) throw new Error("sprite anim speed cannot be 0");
            ...
            play (h, g = {
                ...
                let p = u.anims[h];
                if (p == null) throw new Error(`anim not found: ${h}`);
                d && this.stop(), d = {
                    name: h,
                    timer: 0,
                    loop: (B = (M = g.loop) != null ? M : p.loop) != null ? B : !1,
                    pingpong: (te = (K = g.pingpong) != null ? K : p.pingpong) != null ? te : !1,
                    speed: (Ie = (ke = g.speed) != null ? ke : p.speed) != null ? Ie : 10,
                    onEnd: (Le = g.onEnd) != null ? Le : ()=>{
                    }
    ...
    function Or(n, s = {
        ...
        function u() {
            ...
            if (!m) throw new Error(`font not found: "${d}"`);
            let l = a.fmtText(se(ne({
            }, He(this)), {
                text: this.text + "",
                size: this.textSize,
                font: m,
    ...
    function zr(n = {
        ...
        return {
            ...
            weight: (h = n.weight) != null ? h : 1,
            solid: (g = n.solid) != null ? g : !0,
            update () {
                var M;
                let p = !1;
                if (u) {
                    let B = this.worldArea(), K = u.worldArea(), te = B.p2.y, ke = K.p1.y, Ie = B.p1.x, Le = B.p2.x, st = K.p1.x, it = K.p2.x;
                    !u.exists() || te !== ke || Le < st || Ie > it ? (this.trigger("fall", u), u = null, d = null, p = !0) : d && u.pos && (this.pos = this.pos.add(u.pos.sub(d)), d = u.pos.clone());
                }
                if (!u) {
                    let B = this.move(0, s);
                    if (B) {
                        if (B.isBottom()) {
                            u = B.target;
                            let K = s;
                            s = 0, u.pos && (d = u.pos.clone()), p || (this.trigger("ground", u), m = !0);
            ...
            doubleJump (p) {
                this.isGrounded() ? this.jump(p) : m && (m = !1, this.jump(p), this.trigger("doubleJump"));
            },
            onGround (p) {
    ...
    function Kr(n, s) {
        ...
        return {
            ...
            state: n,
            enterState (m, ...l) {
                if (s && !s[m]) throw new Error(`State not found: ${m}`);
                u[this.state].leave.forEach((h)=>h()
                ), this.state = m, u[this.state].enter.forEach((h)=>h(...l)
                );
            },
            onStateEnter (m, l) {
    ...
    let Q = {
        ...
        clearLog: D.clear,
        log: (n)=>D.info(`[${r.time().toFixed(2)}] ${n}`)
        ,
        error: (n)=>D.error(`[${r.time().toFixed(2)}] ${n}`)
        ,
        curRecording: null,
        get paused () {
            return y.paused;
        ...
        set paused (n1){
            y.paused = n1, n1 ? t.ctx.suspend() : t.ctx.resume();
        }
    };
    function _e(n) {
    ...
    function tn(n, ...s) {
        ...
        let u = y.on("updateStart", ()=>{
            y.events = {
                ...
                angle: 0,
                shake: 0
            }, y.camMousePos = r.mousePos(), y.camMatrix = le(), y.layers = {
            }, y.defLayer = null, y.gravity = J, y.scenes[n](...s), e.debug !== !1 && Ae(), e.burp && fe(), u();
        });
    }
    i(tn, "go");
    function rn(n, s) {
    ...
    function sn(n, s) {
        ...
        let u = [], d = c(s.pos || c(0)), m = 0, l = {
            ...
            spawn (h, ...g) {
                let p = c(...g), M = (()=>{
                    if (s[h]) {
                        if (typeof s[h] != "function") throw new Error("level symbol def must be a function returning a component list");
                        return s[h](p);
                    } else if (s.any) return s.any(h, p);
                })();
                if (!M) return;
    ...
    let Xe = {
        ...
        mousePos: Y,
        mouseWorldPos: ie,
        mouseDeltaPos: r.mouseDeltaPos,
        isKeyDown: r.isKeyDown,
        isKeyPressed: r.isKeyPressed,
        isKeyPressedRepeat: r.isKeyPressedRepeat,
        isKeyReleased: r.isKeyReleased,
        isMouseDown: r.isMouseDown,
        isMousePressed: r.isMousePressed,
        isMouseReleased: r.isMouseReleased,
        isMouseMoved: r.isMouseMoved,
        keyIsDown: r.isKeyDown,
        keyIsPressed: r.isKeyPressed,
        keyIsPressedRep: r.isKeyPressedRepeat,
        keyIsReleased: r.isKeyReleased,
        mouseIsDown: r.isMouseDown,
        mouseIsClicked: r.isMousePressed,
        mouseIsReleased: r.isMouseReleased,
        mouseIsMoved: r.isMouseMoved,
        loop: bt,
        wait: xe,
        play: N,
        volume: t.volume,
    ...
    if (Et(Ir), e.plugins && e.plugins.forEach(Et), e.global !== !1) for(let n2 in Xe)window[n2] = Xe[n2];
    let zt = 0;
    function kn() {
        return zt;
    }
    ...
    function an() {
        ...
        if (n === 1) y.loaded = !0, y.trigger("load");
        else {
    ...
    function un() {
        ...
        if (Q.inspect) {
            let m = function(l, h) {
                let g = a.scale(), p = c(6).scale(1 / g), M = a.fmtText({
                    text: h,
                    font: u,
                    size: 16 / g,
                    pos: l.add(c(p.x, p.y)),
                    color: I(255, 255, 255)
                }), B = M.width + p.x * 2, K = M.height + p.x * 2;
                a.pushTransform(), l.x + B >= b() && a.pushTranslate(c(-B, 0)), l.y + K >= P() && a.pushTranslate(c(0, -K)), a.drawRect({
                    pos: l,
                    width: B,
                    height: K,
                    color: I(0, 0, 0),
            ...
            i(m, "drawInspectTxt");
            let s = null, u = v.fonts[A], d = I((n = e.inspectColor) != null ? n : [
                0,
                0,
                255
            ]);
            if (me((l)=>{
                ...
                let l = [], h = s.inspect();
                for(let g in h)h[g] ? l.push(`${g}: ${h[g]}`) : l.push(`${g}`);
                m(Y(), l.join(`
`));
            }
            m(c(8), `FPS: ${r.fps()}`);
        ...
        if (Q.timeScale !== 1) {
            ...
            for(let d = 0; d < 2; d++){
                let m = Q.timeScale < 1;
                a.drawTriangle({
                    p1: c(-u.width - s * (m ? 2 : 3.5), -s),
                    p2: c(-u.width - s * (m ? 2 : 3.5), -s - u.height),
                    p3: c(-u.width - s * (m ? 3.5 : 2), -s - u.height / 2),
                    pos: c(-d * s * 1 + (m ? -s * 0.5 : 0), 0),
                    color: I(255, 255, 255)
                });
            }
            a.drawFmtText(u), a.popTransform();
        }
        Q.curRecording && (a.pushTransform(), a.pushTranslate(0, P()), a.pushScale(1 / r.scale), a.pushTranslate(24, -24), a.drawCircle({
            radius: 12,
            color: I(255, 0, 0),
            opacity: Pt(0, 1, r.time() * 4)
        }), a.popTransform()), Q.showLog && D.draw();
    }
    return i(un, "drawDebug"), r.run(()=>{
        zt++, y.loaded ? (y.camMousePos = y.camMatrix.invert().multVec2(r.mousePos()), y.trigger("input"), !Q.paused && e.debug !== !1 && Zt(), a.frameStart(), on(), e.debug !== !1 && un(), a.frameEnd()) : (a.frameStart(), an(), a.frameEnd());
    }), e.debug !== !1 && Ae(), e.burp && fe(), window.addEventListener("error", (n)=>{
...
},{}]},["4LOpm","bP9EE"], "bP9EE", "parcelRequire3a3d")
