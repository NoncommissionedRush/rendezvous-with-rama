(() => {
  ...
  var Bt = (e, t, r) => t in e ? jt(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
  var ne = (e, t) => {
    for (var r in t || (t = {}))
  ...
  var se = (e, t) => cn(e, ln(t));
  var i = (e, t) => jt(e, "name", { value: t, configurable: true });
  ...
  var Es = i((e = {}) => {
    ...
    function R(n, s) {
      if (Array.isArray(n)) {
        ...
        return typeof n == "function" ? y.on("input", () => r.isKeyPressed() && n()) : y.on("input", () => r.isKeyReleased(n) && s());
    }
    i(R, "onKeyRelease");
    function x(n, s) {
